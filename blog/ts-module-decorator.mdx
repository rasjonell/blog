---
date: 2020-07-08
slug: typescript-module-decorators
...
Thats it! now if go to our controller and inspect the imported Daemon module we can see that all the functions kept their original signatures.
